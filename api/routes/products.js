...
router.post('/', upload.single('productImage'), checkAuth, function(req, res){
...
router.patch('/:productId', checkAuth, function(req, res){
    const id = req.params.productId;
    const updateOps = {};
...
router.delete('/:productId', checkAuth, function(req, res){
    const id = req.params.productId;
